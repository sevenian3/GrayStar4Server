...
public class LineGrid {
     ...
     * @return
     */
    public static double[][] lineGridDelta(double lam0In, double massIn, double xiTIn,
            int numDeps, double teff) {
  ...
  //
  //
    public static double[][] lineGridGauss(double lam0In, double massIn, double xiTIn,
            int numDeps, double teff, int numCore) {
