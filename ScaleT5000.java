 ...
 * @author Ian
 */
public class ScaleT5000{

    public static double phxRefTeff = 5000.0;
    public static double phxRefLogEg = Math.log(10.0) * 4.5;  //base e!
//He abundance from  Grevesse Asplund et al 2010
    ...
    public static double[] logPhxRefTau64() {
        ...
        int numPhxDep = ScaleT5000.phxRefTau64.length;
        double logPhxRefTau64[] = new double[numPhxDep];
        for (int i = 1; i < numPhxDep; i++) {
            logPhxRefTau64[i] = Math.log(ScaleT5000.phxRefTau64[i]);
        }
    ...
    public static double[][] phxRefTemp(double teff, int numDeps, double[][] tauRos) {
        ...
        for (int i = 0; i < numDeps; i++) {
            phxRefTemp[i] = ToolBox.interpol(ScaleT5000.logPhxRefTau64(), phxRefTemp64, tauRos[1][i]);
            scaleTemp[0][i] = teff * phxRefTemp[i] / ScaleT5000.phxRefTeff;
