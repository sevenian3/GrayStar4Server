...
// As of Feb 2017 - try the band-head value R_00^2 from last column of table:
   double RSqu = 0.0; //default initialization
    ...
    //#CH A^2Delta_X^2Pi system - "G band" at 4300 A
       if ("CH_A2Delta_X2Pi".equals(system)){
...
public static double getFel(String system){
...
// // ROtational & vibrational constants for TiO states:, Tab 2 of Jorgensen"""
    ...
    double fel = 0.0; //default initialization
    ...
    if ("TiO_B3Pi_X3Delta".equals(system)){
        fel  = 0.14;
    }
    
    //#TiO epsilon system    
    if ("TiO_E3Pi_X3Delta".equals(system)){
        fel = 0.014;
    }
      
    //#TiO delta system    
    if ("TiO_b1Pi_a1Delta".equals(system)){
        fel = 0.048 ;   
    }
        
    //#TiO phi system    
    if ("TiO_b1Pi_d1Sigma".equals(system)){
        fel = 0.052;       
    }           
...
public static int getDeltaLambda(String system){
