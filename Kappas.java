...
public class Kappas {
    ...
    public static double[][] kappas(int mode, int numDeps, double[][] rho, double[][] rhoRef, double[][] kappaRosSun, double kappaScale, double logg, double loggSun, double teff, double teffSun, double radius,
