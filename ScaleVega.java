...
public class ScaleVega {
    ...
    public static double[][] phxVegaTemp(double teff, int numDeps, double[][] tauRos) {
        ...
        for (int i = 0; i < numDeps; i++) {
            phxVegaTemp[i] = ToolBox.interpol(ScaleVega.logPhxVegaTau64(), phxVegaTemp64, tauRos[1][i]);
    ...
    public static double[][] phxVegaPGas(double grav, int numDeps, double[][] tauRos) {
        ...
        for (int i = 0; i < numDeps; i++) {
            logPhxVegaPGas[i] = ToolBox.interpol(ScaleVega.logPhxVegaTau64(), logPhxVegaPGas64, tauRos[1][i]);
    ...
    public static double[][] phxVegaNe(double grav, int numDeps, double[][] tauRos, double[][] scaleTemp, double kappaScale) {
        ...
        for (int i = 0; i < numDeps; i++) {
            logPhxVegaPe[i] = ToolBox.interpol(ScaleVega.logPhxVegaTau64(), logPhxVegaPe64, tauRos[1][i]);
...
// Yeah - everywhere ya go - opacity fudge
        ...
        for (int i = 0; i < numDeps; i++) {
            phxVegaKappa[1][i] = ToolBox.interpol(ScaleVega.logPhxVegaTau64(), logPhxVegaKappa64, tauRos[1][i]);
