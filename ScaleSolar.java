...
public class ScaleSolar {
    ...
    public static double[][] phxSunTemp(double teff, int numDeps, double[][] tauRos) {
        ...
        for (int i = 0; i < numDeps; i++) {
            phxSunTemp[i] = ToolBox.interpol(ScaleSolar.logPhxSunTau64(), phxSunTemp64, tauRos[1][i]);
    ...
    public static double[][] phxSunPGas(double grav, int numDeps, double[][] tauRos) {
        ...
        for (int i = 0; i < numDeps; i++) {
            logPhxSunPGas[i] = ToolBox.interpol(ScaleSolar.logPhxSunTau64(), logPhxSunPGas64, tauRos[1][i]);
    ...
    public static double[][] phxSunNe(double grav, int numDeps, double[][] tauRos, double[][] scaleTemp, double kappaScale) {
        ...
        for (int i = 0; i < numDeps; i++) {
            logPhxSunPe[i] = ToolBox.interpol(ScaleSolar.logPhxSunTau64(), logPhxSunPe64, tauRos[1][i]);
...
// Yeah - everywhere ya go - opacity fudge
        ...
        for (int i = 0; i < numDeps; i++) {
            phxSunKappa[1][i] = ToolBox.interpol(ScaleSolar.logPhxSunTau64(), logPhxSunKappa64, tauRos[1][i]);
